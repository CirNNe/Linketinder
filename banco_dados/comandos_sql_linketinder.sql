...
-- INSERT INTO candidatos(nome, data_nascimento, email, cpf, pais, cep, descricao_pessoal, senha) VALUES('Candidato Um', '1991-01-01', 'candidatoum@acelerazg.com.br', 11111111111111, 'Brasil', 11111111, 'descrição candidato 1', '@senhacandidato1');
-- INSERT INTO candidatos(nome, data_nascimento, email, cpf, pais, cep, descricao_pessoal, senha) VALUES('Candidato Dois', '1982-02-02', 'candidato2@acelerazg.com.br', 22222222222, 2, 'Argentina, 'descrição candidato 2', '!candidato2senha');
-- INSERT INTO candidatos(nome, data_nascimento, email, cpf, pais, cep, descricao_pessoal, senha) VALUES('Candidato Três', '1973-03-03', '3candidato@acelerazg.com.br', 33333333333, 3, 'Estados Unidos', 'descrição candidato 3', 'Candidato_Tres3');
-- INSERT INTO candidatos(nome, data_nascimento, email, cpf, pais, cep, descricao_pessoal, senha) VALUES('Candidato Quatro', '2004-04-04', 'candidatoQuatro@acelerazg.com.br', 44444444444, 4, 'Portugual', 'descrição candidato 4', 'SenhaCANDIDATO_4');
-- INSERT INTO candidatos(nome, data_nascimento, email, cpf, pais, cep, descricao_pessoal, senha) VALUES('Candidato Cinco', '2005-05-05', 'Cincocandidato@acelerazg.com.br', 55555555555, 5, 'Canada', 'descrição candidato 5', 'SENHAcandidato@five5');
