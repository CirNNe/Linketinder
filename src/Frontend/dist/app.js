...
document.addEventListener('DOMContentLoaded', function () {
    /* CANDIDATO */
    const telaOpcoesCandidato = document.querySelector("#conteudo-candidato");
    const telaCadastroCandidato = document.querySelector("#conteudo-cadastro-candidato");
    const telaVagas = document.querySelector("#conteudo-vagas");
    const botaoOpcaoCadastrarCandidato = document.querySelector("#botao-escolha-cadatrar-candidato");
    const botaoOpcaoVagasDisponiveis = document.querySelector("#botao-escolha-vagas");
    const botaoCadastrarNovoCandidato = document.querySelector("#botao-cadastrar-novo-candidato");
    const inputNomeNovoCandidato = document.querySelector("#nome-novo-candidato");
    const inputEmailNovoCandidato = document.querySelector("#email-novo-candidato");
    const inputIdadeNovoCandidato = document.querySelector("#idade-novo-candidato");
    const inputCpfNovoCandidato = document.querySelector("#cpf-novo-candidato");
    const inputCepNovoCandidato = document.querySelector("#cep-novo-candidato");
    const inputDescricaoPessoalNovoCandidato = document.querySelector("#descricao-pessoal-novo-candidato");
    const inputCompetencias = document.getElementsByName("competencias-novo-candidato");
    /* EMPRESA */
    const telaOpcoesEmpresa = document.querySelector("#conteudo-empresa");
    const telaCadastroEmpresa = document.querySelector("#conteudo-cadastro-empresa");
    const telaCadastroVaga = document.querySelector("#conteudo-cadastro-vaga");
    const telaListaCandidatos = document.querySelector("#conteudo-lista-candidatos");
    ...
    function salvarCandidatoLocalStorage(candidato) {
        let listaCandidatos = localStorage.getItem('candidatos');
        if (listaCandidatos) {
    ...
    function mostrarListaCandidatos() {
        const listaCandidatosLocalStorage = localStorage.getItem('candidatos');
